...
public class SmallestMissingNumberTest {
    ...
    public void find_1() {
        ...
        assertEquals(3, smallestMissingNumber.findMissingNumber(arr, 10));
    }
    ...
    public void find_2() {
        ...
        assertEquals(0, smallestMissingNumber.findMissingNumber(arr, 12));
    }
    ...
    public void find_3() {
        ...
        assertEquals(4, smallestMissingNumber.findMissingNumber(arr, 5));
    }
    ...
    public void find_4() {
        ...
        assertEquals(8, smallestMissingNumber.findMissingNumber(arr, 11));
    }
    ...
    public void find_5() {
        ...
        assertEquals(4, smallestMissingNumber.findMissingNumber(arr, 20));
    }
}